...
namespace {
constexpr int kJetBurnRenderQueue = 100;
}
...
void JetEngineBurn::Init(const std::string& _name) {
	...
	object_ = AOENGINE::SceneRenderer::GetInstance()->AddObject<AOENGINE::BaseGameObject>("JetBurn", "Object_JetBurn.json", kJetBurnRenderQueue);
