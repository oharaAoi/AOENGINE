...
///////////////////////////////////////////////////////////////////////////////////////////////
//  接続中のブロックグループがダメージ床で壊された時の処理
///////////////////////////////////////////////////////////////////////////////////////////////
void Player::OnConnectedBlockGroupDestroyed(int groupId){
	if(!blockGroupConnectState_.DiscardConnectedGroups(groupId)){
		return;
	}
	// 数え直しになるので、出ていたコンボ表示は全て消し始める
	comboTextUIManager_.StartFadeOutAll();
}
