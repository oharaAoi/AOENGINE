...
void WinApp::CreateGameWindow(uint32_t _backBufferWidth, uint32_t _backBufferHeight, const char* _windowTitle) {
	// windowの大きさを取得 ---------------------------------------------
	nlohmann::json data = AOENGINE::JsonSerializer::Load(kAssetPath + "/Property", "WindowProperty");
...
void WinApp::Finalize() {
	...
	AOENGINE::JsonSerializer::Save(kAssetPath + "/Property", "WindowProperty", data);
}
